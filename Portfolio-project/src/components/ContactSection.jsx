            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                        ...
                        <div className="flex items-start space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:nunoomensahemmanuel224@gmail.com" 
                                     className="texted-muted-foreground hover:text-primary transition-colors">
                                    nunoomensahemmanuel224@gmail.com
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                        <h3 className="text-2xl font-semibold mb-5"> Send a Message
                        </h3>
